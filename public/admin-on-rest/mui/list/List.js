...
import queryReducer, { SET_SORT, SET_PAGE, SET_FILTER } from 'admin-on-rest/lib/reducer/resource/list/queryReducer';
import Title from 'admin-on-rest/lib/mui/layout/Title';
import Pagination from 'admin-on-rest/lib/mui/list/Pagination';
import CreateButton from 'admin-on-rest/lib/mui/button/CreateButton';
...
export class List extends Component {
    ...
    render() {
        ...
        return (
            <Card style={{margin: '1em', opacity: isLoading ? 0.8 : 1 }}>
